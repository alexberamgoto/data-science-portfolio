"""
═══════════════════════════════════════════════════════════════
BATCH JOB 1 : Engagement utilisateur (historique)
═══════════════════════════════════════════════════════════════
Ce job calcule le niveau global d'activité de chaque utilisateur
sur l'ensemble des données historiques :
  - Nombre total d'actions
  - Temps total passé (en secondes et en heures)
...
print(f"\n📊 Nombre total d'événements : {df.count()}")
...
# ─── Distribution par plateforme préférée ───
print("\n📱 RÉPARTITION DES UTILISATEURS PAR PLATEFORME PRÉFÉRÉE :")
...
print("✅ Copie CSV locale dans /data/results/engagement_utilisateur")
